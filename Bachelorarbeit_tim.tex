...
% - -------------------------------------------------------------------------
  \createAbstract					{Bachelor}												%							% Art der Arbeit
													{thesis}								%											% Bezeichnung arbeit oder thesis 
													{Tim Staats}					%							% Author
													{Weiterentwicklung einer Geodatenbasierten Multi-Nutzer Android App für historische Monumente}											  % Titel				
													...
													{Diese Arbeit dokumentiert die Weiterentwicklung einer Android Applikation. Die App bietet registrierten Nutzern die Möglichkeit historische Monumente zu erfassen und zu katalogisieren. Des  Weiteren visualisiert die App die katalogisierten Daten auf eine google Map und in Form von detailierten Listen. Im dazugehörigen Backend werden die Daten verwaltet und in einer Web Applikation visualisiert. Die dafür erforderlichen Maßnahmen, Konzepte, Probleme und deren Lösungen werden im folgenden beschrieben.
}																					% Kurzzusammenfassung
...
%---------------------------------------------------------------------------------------------------
	\input{chapter/Analysis/Analysis.tex}

%---------------------------------------------------------------------------------------------------
% Der dritte Teil der Arbeit
%---------------------------------------------------------------------------------------------------
	\input{chapter/Design/Design.tex}
														
%---------------------------------------------------------------------------------------------------	
% Der vierter Teil der Arbeit
%---------------------------------------------------------------------------------------------------
	\input{chapter/Realization/Realization.tex}
														
%---------------------------------------------------------------------------------------------------	
% Der fuenfter Teil der Arbeit
%---------------------------------------------------------------------------------------------------
	\input{chapter/Tests/Tests.tex}
