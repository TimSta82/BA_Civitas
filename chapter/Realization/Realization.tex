...
\begin{figure}[H]
	\centering \includegraphics[width=0.8\textwidth]{backendless_console_artefact_table.png}
...
images and audios
\begin{figure}[H]
	\centering \includegraphics[width=0.8\textwidth]{backendless_console_files.png}
...
\begin{figure}[H]
	\centering \includegraphics[width=0.8\textwidth]{backendless_console_geolocation.png}
